...
public class FollowCamera : MonoBehaviour
{
    ...
    void Update()
    {
         ...
         position = Vector3.SmoothDamp(transform.position, TwoSphere.position + rotation * new Vector3(0, 0, -TargetDistance) + pivotOffset, ref Velocity, SmoothTime);
